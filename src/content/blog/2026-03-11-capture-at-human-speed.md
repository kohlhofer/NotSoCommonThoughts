---
title: "Capture at Human Speed"
description: "AI makes everything possible and nothing restful. Staying intentional means acting on your terms — not reacting to every opportunity the moment it appears."
date: 2026-03-11
...
I've [written before](/blog/think-more-not-just-more) about the importance of protecting time for thinking rather than just doing more. That instinct has only intensified. The volume of what's possible—the [constant iteration](/blog/2026-02-21-coding-as-sculpting), the ability to move from idea to working thing in hours—creates a kind of cognitive pressure that's hard to articulate. It's not burnout exactly. It's the weight of permanent opportunity.
...
I want voice notes transcribed. I want them searchable. I want them available to AI when I'm ready to work with them—as context for a [broader knowledge base](/blog/2026-02-21-context-repository), as triggers for workflows, or simply as a searchable archive of thinking. All of that should happen. But it shouldn't need me there watching it. The moment of capture should be frictionless and human-paced. Everything after that is the machine's job.
...
*[Of all the things you can now do, which do you choose to do?](/blog/project-tree-2025)* That question still sits at the center of working with AI. But there's a prior question that doesn't get enough attention: **when** do you choose to do them?
